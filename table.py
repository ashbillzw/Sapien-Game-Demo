...
class Table(object):
    ...
    def _build_table(self):
        ...
        table_pitch_axle.add_box_collision([1, 1, 4])
        ...
        table_roll_axle.all_box_collision([1, 1, 4])
        ...
        self.testrollaxlejoint = [joint for joint in self.table.get_joints() if joint.name == "Table Roll Axle Bearing"][0]
